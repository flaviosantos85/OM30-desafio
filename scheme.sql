...
INSERT INTO `migrations` VALUES (20200708234230);
...
CREATE TABLE `tb_pacientes` (
  `paciente_id` int(5) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `registered_at` varchar(200) DEFAULT NULL,
...
-- Dump completed on 2020-07-10 20:25:54
